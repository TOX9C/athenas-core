...
export function getAgentCommand(agentType: AgentType, customCmd?: string, options?: { bypass?: boolean }): string | undefined {
  switch (agentType) {
    case 'claude':
