...
pub fn notification_push(
    ...
    serde_json::to_string(&record).map_err(|e| CommandError::Internal(e.to_string()))
}
...
pub fn notification_history(
    ...
    serde_json::to_string(&history).map_err(|e| CommandError::Internal(e.to_string()))
}

/// Get the count of unread notifications.
#[tauri::command]
pub fn notification_count(state: State<'_, AppState>) -> Result<usize, CommandError> {
...
#[tauri::command]
pub fn notification_counts(state: State<'_, AppState>) -> Result<String, CommandError> {
    let counts = state.notification_service.get_counts();
    serde_json::to_string(&counts).map_err(|e| CommandError::Internal(e.to_string()))
}
